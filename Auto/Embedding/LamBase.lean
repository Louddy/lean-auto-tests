...
theorem LamWF.interp_bvarAppsRev
  ...
  case cons lty lctxTy lterm lctxTerm IH =>
    ...
    rw [interp_substLCtxTerm_rec (sorry)
      (pushLCtxsDep_substxs _ _ _ (sorry) HList.reverse_cons)]
    ...
    case h₁ =>
      ...
      case h₂ =>
        ...
        apply HEq.trans (pushLCtxsDep_ge _ (Nat.le_of_eq (sorry)))
